...
p1 <- clonal_pie(lib_size = 100,  repl = 1)
p2 <- clonal_pie(lib_size = 1000, repl = 1)
p3 <- clonal_pie(lib_size = 1500, repl = 1)
p4 <- clonal_pie(lib_size = 5000, repl = 1)

p5 <- clonal_pie(lib_size = 100,  repl = 2)
p6 <- clonal_pie(lib_size = 1000, repl = 2)
p7 <- clonal_pie(lib_size = 1500, repl = 2)
p8 <- clonal_pie(lib_size = 5000, repl = 2)

 p9 <- clonal_pie(lib_size = 100,  repl = 3)
p10 <- clonal_pie(lib_size = 1000, repl = 3)
p11 <- clonal_pie(lib_size = 1500, repl = 3)
p12 <- clonal_pie(lib_size = 5000, repl = 3)
