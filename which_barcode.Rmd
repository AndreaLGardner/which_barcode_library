...
ggplot(min_cells, aes(x=log10(cells_per_rep), y=BC_similarity, group = cells_per_rep, color = as.factor(library_size))) +
  geom_boxplot(outlier.shape = NA) +
  geom_jitter(width=0.1) + theme_few() +
  xlab('log10(number of cells per replicate)') +
  ggtitle('Similarity of replicates from experimental population')
